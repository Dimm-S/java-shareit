...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> saveBooking(BookingDto bookingDto, Long bookerId) {
        return post("", bookerId, bookingDto);
    }

    public ResponseEntity<Object> approveBookingById(Long bookingId, Long ownerId, Boolean approved) {
    ...
    public ResponseEntity<Object> getAllBookingsByOwnerId(
            long ownerId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
